...
public class ScrambledPitsStructure extends AbstractCaveGenerationStructure{
    ...
    public static final MapCodec<Structure> CODEC =simpleCodec(ScrambledPitsStructure::new);



    public ScrambledPitsStructure(StructureSettings settings) {
        super(settings);
    }
...
//    }
    ...
    protected StructurePiece createPiece(BlockPos offset, BlockPos center, int heightBlocks, int widthBlocks, RandomState randomState) {
        return new ScrambledPitsStructurePiece(offset, center.atY(60+(int)(center.getY()/2.5f)), heightBlocks, widthBlocks);
    }
    ...
    public StructureType<?> type() {
        return NMStructureInit.SCRAMBLED_PITS.get();
    }
}
