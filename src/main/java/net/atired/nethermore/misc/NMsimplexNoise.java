...
public class NMsimplexNoise {  // Simplex noise in 2D, 3D and 4D
    ...
    public static float sampleNoise2D(int x, int z, float simplexSampleRate) {
        return (float) ((NMsimplexNoise.noise((x + simplexSampleRate) / simplexSampleRate, (z + simplexSampleRate) / simplexSampleRate)));
    }

    public static float sampleNoise3D(int x, int y, int z, float simplexSampleRate) {
        return (float) ((NMsimplexNoise.noise((x + simplexSampleRate) / simplexSampleRate, (y + simplexSampleRate) / simplexSampleRate, (z + simplexSampleRate) / simplexSampleRate)));
    }
